...
--
-- Table structure for table `excluiritem`
--

DROP TABLE IF EXISTS `excluiritem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `excluiritem` (
  `ItemId` int NOT NULL,
  `Id` int NOT NULL,
  PRIMARY KEY (`ItemId`),
  CONSTRAINT `excluiritem_ibfk_1` FOREIGN KEY (`ItemId`) REFERENCES `item` (`ItemId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `excluiritem`
--

LOCK TABLES `excluiritem` WRITE;
/*!40000 ALTER TABLE `excluiritem` DISABLE KEYS */;
/*!40000 ALTER TABLE `excluiritem` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `item` (
  ...
  `localizacaoFisica` varchar(10) NOT NULL,
  `titulo` varchar(50) DEFAULT NULL,
  `urlimgitem` varchar(70) NOT NULL,
  PRIMARY KEY (`ItemId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `modificaritem`
--

DROP TABLE IF EXISTS `modificaritem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `modificaritem` (
  `ItemId` int NOT NULL,
  `autor` varchar(40) NOT NULL,
...
--
-- Dumping data for table `modificaritem`
--

LOCK TABLES `modificaritem` WRITE;
/*!40000 ALTER TABLE `modificaritem` DISABLE KEYS */;
/*!40000 ALTER TABLE `modificaritem` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `realizardevolucao`
--

DROP TABLE IF EXISTS `realizardevolucao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `realizardevolucao` (
  `ItemId` int NOT NULL,
  PRIMARY KEY (`ItemId`),
  CONSTRAINT `realizardevolucao_ibfk_1` FOREIGN KEY (`ItemId`) REFERENCES `item` (`ItemId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `realizardevolucao`
--

LOCK TABLES `realizardevolucao` WRITE;
/*!40000 ALTER TABLE `realizardevolucao` DISABLE KEYS */;
/*!40000 ALTER TABLE `realizardevolucao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `solicitaremprestimo`
--

DROP TABLE IF EXISTS `solicitaremprestimo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `solicitaremprestimo` (
  `Id` int NOT NULL,
  `ItemId` int NOT NULL,
  ...
  KEY `ItemId` (`ItemId`),
  CONSTRAINT `solicitaremprestimo_ibfk_1` FOREIGN KEY (`Id`) REFERENCES `usuario` (`Id`),
  CONSTRAINT `solicitaremprestimo_ibfk_2` FOREIGN KEY (`ItemId`) REFERENCES `item` (`ItemId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `solicitaremprestimo`
--

LOCK TABLES `solicitaremprestimo` WRITE;
/*!40000 ALTER TABLE `solicitaremprestimo` DISABLE KEYS */;
/*!40000 ALTER TABLE `solicitaremprestimo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-11-29 18:51:36',NULL),('diagnostics.include_raw','OFF','2023-11-29 18:51:36',NULL),('ps_thread_trx_info.max_length','65535','2023-11-29 18:51:36',NULL),('statement_performance_analyzer.limit','100','2023-11-29 18:51:36',NULL),('statement_performance_analyzer.view',NULL,'2023-11-29 18:51:36',NULL),('statement_truncate_len','64','2023-11-29 18:51:36',NULL);
...
-- Dump completed on 2023-12-11 16:54:01
